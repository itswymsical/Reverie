...
using Reverie.Content.Archaea.Tiles.RedDesert;
using Terraria;
using Terraria.ID;
using Terraria.ModLoader;
using static Terraria.ModLoader.ModContent;

namespace Reverie.Content.Archaea.Tiles.Projectiles
{

	public class RedSandBall : ModProjectile
    {
        protected bool falling = true;
		protected int tileType;
		protected int dustType;
        public override string Texture => Assets.Archaea.Tiles.Projectiles + Name;
        public override void SetStaticDefaults() => ProjectileID.Sets.ForcePlateDetection[Projectile.type] = true;
        ...
        public override bool? CanDamage() => Projectile.localAI[1] == 0f;    
    }
}