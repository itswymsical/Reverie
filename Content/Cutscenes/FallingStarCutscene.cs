...
public class FallingStarCutscene : Cutscene
{
    ...
    private const int TRAIL_SEGMENTS = 12; // Increased number of trail segments
    ...
    protected override void OnCutsceneStart()
    {
        ...
        silhouetteTexture = ModContent.Request<Texture2D>($"{VFX_DIRECTORY}PlayerSilhouette", ReLogic.Content.AssetRequestMode.ImmediateLoad).Value;
    ...
    protected override void OnCutsceneEnd()
    {
        ...
        silhouetteActive = false;
        CameraSystem.shake = 0; // Ensure camera shake is reset
