...
public partial class IllustriousMenu : ModMenu
{
    ...
    public override string DisplayName => "Illustrious Space";
    ...
    public static bool InMenu => MenuLoader.CurrentMenu == ModContent.GetInstance<IllustriousMenu>() && Main.gameMenu;
