...
public class DownedSystem : ModSystem
{
    ...
    public static bool argieCutscene = false;
    ...
    public override void LoadWorldData(TagCompound tag)
    {
        ...
        argieCutscene = tag.ContainsKey("argieCutscene");
    }

    public override void NetSend(BinaryWriter writer)
    {
        // Order of parameters is important and has to match that of NetReceive
        writer.WriteFlags(foundChronicleI);
        writer.WriteFlags(initialCutscene, argieCutscene);
    ...
    public override void NetReceive(BinaryReader reader)
    {
        ...
        reader.ReadFlags(out foundChronicleI);
        reader.ReadFlags(out initialCutscene, out argieCutscene);
