...
public class RainforestUndergroundPass : GenPass
{
    #region Fields
    ...
    public RainforestUndergroundPass() : base("Rainforest Understory", 150f)
    {
    ...
    protected override void ApplyPass(GenerationProgress progress, GameConfiguration configuration)
    {
        ...
        {
            progress.Message = "No jungle detected - skipping Rainforest generation";
            return;
        }

        progress.Message = "Calculating Rainforest placement...";
        CalculateRainforestBounds();

        if (!_rainforestBounds.IsValid)
        {
            progress.Message = "Insufficient space for Rainforest - skipping generation";
            return;
        }

        progress.Message = "Growing Rainforest Understory...";
    ...
    private bool IsRainforestSurfaceTile(int x, int y)
    {
        ...
        return tile.HasTile && (tile.TileType == (ushort)ModContent.TileType<OxisolTile>() ||
    ...
    {
        progress.Message = "Initializing Rainforest shape...";
        ...
        progress.Message = "Carving Rainforest caves...";
