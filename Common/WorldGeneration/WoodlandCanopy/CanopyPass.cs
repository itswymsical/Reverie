using Reverie.Content.NPCs.WorldNPCs;
    ...
    public void CarveRoots()
    {
        ...
        for (var x = 0; x < posx; x++)
        {
            for (var y = 0; y < posy; y++)
            {
                ...
                noiseData[x, y] = roots.GetNoise(worldX / 2, worldY - worldY / 4.5f);
            }
        }
        ...
        {
            StructureHelper.API.Generator.GenerateStructure("Structures/StumpyHouse", new Point16(houseX, houseY), Instance);
